                ...
                <div class="col-md-12">
                    <div class="panel panel-grape">
                        <div class="panel-heading">
                            All admin
                            <div class="options">
                                <a href="<?php echo base_url('admin/add') ?>"><i class="fa fa-plus" title="Add New"></i></a>
                            </div>
                        </div>
                                ...
                                <tbody>
                                    <?php foreach ($data_all->data as $key => $dataVal) { ?>
                                        <tr class="odd gradeX">
                                            ...
                                            <td><?php echo $dataVal->email; ?></td>
                                            <td><?php echo $dataVal->status; ?></td>
                                            <td><?php echo $dataVal->type; ?></td>
        ...
        $('.datatables').dataTable()
                .columnFilter({
                    aoColumns: [
                        ...
                        null,
                        null,
                        {type: "select", values: ['Sub-admin', 'Super-admin']},
                        null,
                        null
                    ]
...
<script>
    $(document).ready(function () {
        ...
        $('.datatable ').on("click", '.view', function () { //any Click on Delete icon
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo base_url('admin/view'); ?>",
                data: {postID: postVal},
