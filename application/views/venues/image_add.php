        ...
        <div class="container">
            ...
            <div class="panel panel-midnightblue">
                ...
                <div class="panel-body collapse in">
                    <form action="<?php echo base_url('venues/imagesadd') . '/' . $venueValue[0]->id; ?>" class="form-horizontal row-border" method="post" enctype="multipart/form-data">
                        ...
                        <input type="hidden" name="venue_id" value="as">
                            ...
                            <div class="row">
                                <div class="col-sm-6 col-sm-offset-3">
                                    <div class="btn-toolbar">
                                        ...
                                        <a href="<?php echo base_url('venues/images') . '/' . $venueValue[0]->id; ?>" class="btn btn-default">Cancel</a>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<?php if (isset($successMsg)) { ?>
    <script>
        ...
        window.location.replace("<?php echo base_url('venues/images') . '/' . $venueValue[0]->id; ?>");
