        ...
        <div class="container">
            ...
            <div class="panel panel-midnightblue">
                ...
                <div class="panel-body collapse in">
                    <form action="<?php echo base_url('venues/viptableadd').'/'.$venueValue[0]->id; ?>" class="form-horizontal row-border" method="post" enctype="multipart/form-data">
                        <div class="form-group">
                            <label class="col-sm-3 control-label">Title</label>
                            <div class="col-sm-6">
                                <input type="text" class="form-control" name="venue_table_title" placeholder="Title" value="<?php echo set_value('venue_table_title') ?>">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input type="text" class="form-control" name="venue_table_price" placeholder="Ptice" value="<?php echo set_value('venue_table_price') ?>">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input type="text" class="form-control" name="venue_table_bottle_amount" placeholder="Bottle Amount" value="<?php echo set_value('venue_table_bottle_amount') ?>">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input type="text" class="form-control" name="venue_table_components_amount" placeholder="Component Amount" value="<?php echo set_value('venue_table_components_amount') ?>">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input type="text" class="form-control" name="venue_table_description" placeholder="Description" value="<?php echo set_value('venue_table_description') ?>">
