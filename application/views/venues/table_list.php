    ...
    <div id='wrap'>
        <div id="page-heading">
            <ol class="breadcrumb">
                ...
                <li class=''>Vip tables</li>
            </ol>

            <h1>All Tables of <?php echo $venueValue[0]->venue_title;?></h1>
        </div>
                ...
                <div class="col-md-12">
                    <div class="panel panel-grape">
                        <div class="panel-heading">
                            All tables
                            <div class="options">
                                <a href="<?php echo base_url('venues/viptableadd').'/'.$venueValue[0]->id; ?>"><i class="fa fa-plus" title="Add New"></i></a>
                            </div>
                        </div>
                            ...
                            <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered datatables" id="example">
                                ...
                                <tbody>
                                    <?php foreach ($data_all->data as $key => $dataVal) { ?>
                                        <tr class="odd gradeX">
                                            <td><?php echo $dataVal->venue_table_title; ?></td>
                                            <td><?php echo $dataVal->venue_table_price; ?></td>
                                            <td><?php echo $dataVal->venue_table_bottle_amount; ?></td>
                                            <td><?php echo $dataVal->venue_table_components_amount; ?></td>
                                            <td><?php echo $dataVal->venue_table_description; ?></td>
