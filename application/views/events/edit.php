        ...
        <div class="container">
            ...
            <div class="panel panel-midnightblue">
                ...
                <div class="panel-body collapse in">
                    <form action="<?php echo base_url('events/edit') . '/' . $data->id; ?>" class="form-horizontal row-border" method="post" enctype="multipart/form-data">
                            ...
                            <div class="col-sm-6">
                                <select class="form-control" placeholder="Dropdown" name="event_venue">
                                    ...
                                    <?php foreach ($venueValue as $venueVal) { ?>
                                        <option value="<?php echo $venueVal->id; ?>"<?php echo $venueVal->id = $data->event_venue ? 'selected' : ''; ?> ><?php echo $venueVal->venue_title; ?></option>
                                    <?php } ?>
                                </select>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input type="text" class="form-control" name="event_title" placeholder="Title" value="<?php echo $data->event_title; ?>">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input type="text" class="form-control" name="event_address" placeholder="Address" value="<?php echo $data->event_address; ?>">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input type="text" class="form-control" name="event_email" placeholder="Email" value="<?php echo $data->event_email; ?>">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input type="text" class="form-control" name="event_mobile" placeholder="Mobile" value="<?php echo $data->event_mobile; ?>">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input type="text" name="event_start_date" class="form-control" id="start-date" value="<?php echo date('Y-m-d h a', strtotime($data->event_start_date)); ?>"/>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input type="text" name="event_end_date" class="form-control" id="end-date" value="<?php echo date('Y-m-d h a', strtotime($data->event_end_date)); ?>"/>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input type="text" class="form-control" name="event_additional_info" placeholder="Additional Info" value="<?php echo $data->event_additional_info; ?>">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <select class="form-control" placeholder="Dropdown" name="bottle_service">
                                    <option value="">Please Select:</option>
                                    <option value="1"<?php echo $data->bottle_service == 1 ? 'selected' : ''; ?>>Yes</option>
                                    <option value="0"<?php echo $data->bottle_service == 0 ? 'selected' : ''; ?>>No</option>
                                </select>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <select class="form-control" placeholder="Dropdown" name="rsvp">
                                    <option value="">Please Select:</option>
                                    <option value="1"<?php echo $data->rsvp == 1 ? 'selected' : ''; ?>>Yes</option>
                                    <option value="0"<?php echo $data->rsvp == 0 ? 'selected' : ''; ?>>No</option>
                                </select>
