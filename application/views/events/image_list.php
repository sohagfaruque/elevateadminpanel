...
<div id="page-content">
    <div id='wrap'>
        <div id="page-heading">
            ...
            <h1>All Images of <?php echo $eventValue[0]->event_title;?></h1>
        </div>
                ...
                <div class="col-md-12">
                    <div class="panel panel-grape">
                        <div class="panel-heading">
                            All images
                            <div class="options">
                                <a href="<?php echo base_url('events/imagesadd').'/'.$eventValue[0]->id; ?>"><i class="fa fa-plus" title="Add New"></i></a>
                            </div>
                        </div>
                            ...
                            <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered datatables" id="example">
                                ...
                                <tbody>
                                    <?php foreach ($data_all->data as $key => $dataVal) { ?>
                                        <tr class="odd gradeX">
                                            <td><?php echo $dataVal->event_images; ?></td>
