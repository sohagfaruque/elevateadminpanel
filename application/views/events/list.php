                ...
                <div class="col-md-12">
                    <div class="panel panel-grape">
                        <div class="panel-heading">
                            All Events
                            <div class="options">
                                <a href="<?php echo base_url('events/add') ?>"><i class="fa fa-plus" title="Add New"></i></a>
                            </div>
                        </div>
                            ...
                            <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered datatables" id="example">
                                ...
                                <tbody>
                                    <?php foreach ($data_all->data as $key => $dataVal) { ?>
                                        <tr class="odd gradeX">
                                            <td><?php echo $dataVal->event_title; ?></td>
                                            <td><?php echo $dataVal->event_address; ?></td>
                                            <td><?php echo $dataVal->city_title; ?></td>
                                            <td><?php echo $dataVal->venue_title; ?></td>
                                            <td><?php echo $dataVal->bottle_service; ?></td>
                                            <td><?php echo $dataVal->rsvp; ?></td>
                                            <td><?php echo $dataVal->images; ?></td>
                                            <td><?php echo $dataVal->event_end_date; ?></td>
        ...
        $('.datatables').dataTable()
                .columnFilter({
                    aoColumns: [
                        ...
                        {type: "select", values: [<?php foreach($venueInfo as $venueVal){ echo "'".$venueVal->venue_title."',";}?>]},
                        null,
                        null,
                        null,
                        null,
